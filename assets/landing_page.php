...
<body>
		...
		<div class="container">
			...
			<nav>
				<ul>
					...
					<li><a href="#province" >รถเช่า<?php echo $target;?></a>
	...
	<section itemscope itemtype="http://schema.org/LocalBusiness" class="container">
		...
		<div id="app_info">
			...
			<!-- End Logo -->
			<h1><span class="tagline"><span itemprop="name">คาพลัส - บริการ รถเช่า ในจังหวัด <span class="orange bold bigger"><?php echo $target;?></span></span><br/>รับและคืนรถได้ที่สนามบิน<br/></span></h1>
			...
			<span class="tagline"><span class="green">+ ฟรี ! ประกันภัยชั้นหนึ่ง</span></span>
				...
				<a href="tel:<?php echo $phone_number_for_call;?>" class="large_button align_right font_22 modify_button float_none" id="android">	
